...
def find_ancestor(root, p, q):
    ...
    l_state = find_ancestor(root.left, p, q)
    r_state = find_ancestor(root.right, p, q)
...
class TestFunctions(unittest.TestCase):
    def test_1(self):
        ...
        self.assertEquals(2, state.common_ancestor.value)
        ...
        state = find_ancestor(root, 
                              ...
                              TreeNode(None, None, 10))
        self.assertEquals(1, state.common_ancestor.value)
